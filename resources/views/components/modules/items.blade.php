        ...
        @if ($seeMore)
            <div class="flex items-center mt-10">
                <button
                    ...
                    class="relative w-48 m-auto flex items-center justify-center bg-customs hover:bg-customs-700 text-white px-6 py-1.5 text-base rounded-lg disabled:bg-green-100 js-learn-more js-button-modal-submit"
                >
