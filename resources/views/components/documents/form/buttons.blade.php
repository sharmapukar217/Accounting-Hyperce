<x-form.section>
    <x-slot name="foot">
        <div class="flex justify-end">
            ...
            <x-button
                id="invoice-send-to"
                class="relative flex items-center justify-center bg-customs hover:bg-customs-700 text-white px-6 py-1.5 ltr:ml-2 rtl:mr-2 text-base rounded-lg disabled:bg-customs-100"
                override="class"
